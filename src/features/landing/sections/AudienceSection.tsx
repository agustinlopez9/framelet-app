...
function IconPanel({ children, delay }: { children: React.ReactNode; delay: string }) {
  return (
    <div
      className="aspect-square w-full max-w-[220px] rounded-2xl border border-white/40 bg-gradient-to-br from-primary/15 to-secondary/40 p-12 backdrop-blur-md ring-1 ring-foreground/5 motion-safe:animate-[panel-pulse_4.5s_ease-in-out_infinite]"
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <p
                    className={cn(
                      'mt-3 max-w-xl text-base leading-relaxed text-muted-foreground mx-auto',
